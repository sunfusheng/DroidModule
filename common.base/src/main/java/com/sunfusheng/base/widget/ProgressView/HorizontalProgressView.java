package com.sunfusheng.base.widget.ProgressView;
...
public class HorizontalProgressView extends ProgressBar {
    ...
    private int mNormalBarSize = DisplayUtil.dip2px(2);
    private int mNormalBarColor = Color.parseColor("#FFD3D6DA");
    private int mReachBarSize = DisplayUtil.dip2px(2);
    private int mReachBarColor = Color.parseColor("#108ee9");
    private int mTextSize = DisplayUtil.sp2px(14);
    private int mTextColor = Color.parseColor("#108ee9");
    private int mTextOffset = DisplayUtil.dip2px(6);
    ...
    protected void obtainAttributes(AttributeSet attrs) {
        ...
        mNormalBarSize = (int) ta.getDimension(R.styleable.HorizontalProgressView_hpv_progressNormalSize,
                mNormalBarSize);
        mNormalBarColor =
                ta.getColor(R.styleable.HorizontalProgressView_hpv_progressNormalColor, mNormalBarColor);

        mReachBarSize =
                (int) ta.getDimension(R.styleable.HorizontalProgressView_hpv_progressReachSize, mReachBarSize);
        mReachBarColor =
                ta.getColor(R.styleable.HorizontalProgressView_hpv_progressReachColor, mReachBarColor);

        mTextSize =
                (int) ta.getDimension(R.styleable.HorizontalProgressView_hpv_progressTextSize, mTextSize);
        mTextColor = ta.getColor(R.styleable.HorizontalProgressView_hpv_progressTextColor, mTextColor);
        mTextSkewX = ta.getDimension(R.styleable.HorizontalProgressView_hpv_progressTextSkewX, 0);
        if (ta.hasValue(R.styleable.HorizontalProgressView_hpv_progressTextSuffix)) {
            mTextSuffix = ta.getString(R.styleable.HorizontalProgressView_hpv_progressTextSuffix);
        }
        if (ta.hasValue(R.styleable.HorizontalProgressView_hpv_progressTextPrefix)) {
            mTextPrefix = ta.getString(R.styleable.HorizontalProgressView_hpv_progressTextPrefix);
        }
        mTextOffset =
                (int) ta.getDimension(R.styleable.HorizontalProgressView_hpv_progressTextOffset, mTextOffset);

        mProgressPosition =
                ta.getInt(R.styleable.HorizontalProgressView_hpv_progressTextPosition, mProgressPosition);

        mTextVisible =
                ta.getBoolean(R.styleable.HorizontalProgressView_hpv_progressTextVisible, mTextVisible);
        ta.recycle();
    }
    ...
    public void setNormalBarSize(int normalBarSize) {
        mNormalBarSize = DisplayUtil.dip2px(normalBarSize);
        invalidate();
    }
    ...
    public void setReachBarSize(int reachBarSize) {
        mReachBarSize = DisplayUtil.dip2px(reachBarSize);
        invalidate();
    }
    ...
    public void setTextSize(int textSize) {
        mTextSize = DisplayUtil.sp2px(textSize);
        invalidate();
    }
    ...
    public void setTextOffset(int textOffset) {
        mTextOffset = DisplayUtil.dip2px(textOffset);
        invalidate();
    }
