...
public class ScrollableHelper {
    ...
    public boolean isTop() {
        ...
        if (scrollableView instanceof CollectionView) {
            return isCollectionViewTop((CollectionView) scrollableView);
        }
    ...
    private static boolean isCollectionViewTop(CollectionView collectionView) {
        if (collectionView != null) {
            RecyclerView recyclerView = collectionView.getRecyclerView();
            if (recyclerView != null) {
                return isRecyclerViewTop(recyclerView);
            }
            ListView listView = collectionView.getListView();
            if (listView != null) {
    ...
    public void smoothScrollBy(int velocityY, int distance, int duration) {
        ...
        } else if (scrollableView instanceof CollectionView) {
            CollectionView collectionView = (CollectionView) scrollableView;
            RecyclerView recyclerView = collectionView.getRecyclerView();
            if (recyclerView != null) {
