 ...
 */
public class RightImageViewObject extends BaseNewsViewObject<RightImageViewObject.ViewHolder> {
    ...
    public static ViewObject createViewObject(NewsModel model, Context context, ActionDelegateFactory actionDelegateFactory, ViewObjectFactory viewObjectFactory) {
        BaseNewsViewObject viewObject = new RightImageViewObject(context, model, actionDelegateFactory, viewObjectFactory);
        BaseNewsViewObjectCreator.initVo(model, viewObject);
        return viewObject;
    }

    public RightImageViewObject(Context context, Object data, ActionDelegateFactory actionDelegateFactory, ViewObjectFactory viewObjectFactory) {
